...
const MovieDetails = () => {
  ...
  let posterUrl;
  if (movie.poster_path) posterUrl = API_IMG + movie.poster_path;
  else
    posterUrl =
    ...
    <div className="movie_section">
      <div className="movie_container">
        ...
        <div className="right_movie">
          ...
          <p>
            <b>Popularity:</b> {movie.popularity} million
          </p>
          <p>
            <b>Genres:</b>{" "}
            {genres.map((gen) => {
